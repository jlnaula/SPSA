...
@interface FinishContestViewController ()

@end

@implementation FinishContestViewController
...
- (void)viewDidLoad {
    ...
    [self.lblTitle setText:@"Gracias por votar"];
    ...
    [[NSUserDefaults standardUserDefaults] setObject:@"1" forKey:@"has_voted"];
}
